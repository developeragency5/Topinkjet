...
const PRODUCTS = [
  ...
  },
  {
    ...
    long: "The HP OfficeJet Pro 9110b is a print-only color inkjet built for managed office environments. PCL and PostScript emulation make it a drop-in replacement for legacy office print fleets, while a 250-sheet input tray and automatic two-sided printing keep it productive. Native dual-band Wi-Fi and Gigabit Ethernet round out the connectivity options.",
    specs: {
